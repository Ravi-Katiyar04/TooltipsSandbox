...
//     ({
//       top: 
//          'after:absolute after:top-full after:left-1/2 after:-translate-x-1/2 after:border-8 after:border-transparent after:border-t-gray-800 after:z-10',
//       bottom:
//         'after:absolute after:bottom-full after:left-1/2 after:-translate-x-1/2 after:border-8 after:border-transparent after:border-b-gray-800 after:z-10',
//       left:
//         'after:absolute after:left-full after:top-1/2 after:-translate-y-1/2 after:border-8 after:border-transparent after:border-l-gray-800 after:z-10',
//       right:
//         'after:absolute after:right-full after:top-1/2 after:-translate-y-1/2 after:border-8 after:border-transparent after:border-r-gray-800 after:z-10',
//     }[position]);
...
//         className="px-4 py-2 bg-gray-300 rounded focus:outline-none"
...
//       {visible && (
//         <div
//           className={`absolute z-20 ${positionClass} ${width} ${fontSize} ${shapeClass} shadow-lg text-white ${shape === 'bubble' ? arrowFix : ''
//             } ${shape === 'bubble' ? arrowPositionFix : ''}`}
